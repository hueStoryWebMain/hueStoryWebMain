...
/**
 * PortfolioHeroTHS — full-bleed pattern hero · PORTFOLIO title
 * Soft slate/black overlay (same language as AboutHeroTHS)
 */
export default function PortfolioHeroTHS() {
    ...
    >
      <div
        ...
        style={{
          ...
          backgroundImage: `url(${PATTERN_BG.portfolioPage})`,
